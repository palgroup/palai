...
func canonicalToolExecutionProof() uat.ToolExecutionProof {
	...
	ceilings, err := uat.SweepToolExecutionCeilings(json.RawMessage(uat.ToolExecutionCeilingLedger))
	if err != nil {
