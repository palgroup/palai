...
// 000049 (E29 provider wiring): the ENDPOINT a model connection dials, plus the stamp of the last
...
// Opens from the tip (000048).
//
//go:embed migrations/000049_model_connection_endpoint.up.sql
var migrationUp49 string

//go:embed migrations/000049_model_connection_endpoint.down.sql
