...
// 000035 opens the knowledge spine (E17 Task 4): the immutable FTS ingestion/index/retrieval tables. Every
...
//
// MERGE NOTE: the plan assigns T4 migration 000036 and merges T1's slack 000035 first (fixed order §1);
// this is built as 000035 for chain contiguity in the isolated worktree and renumbered to 000036 at merge.
//
//go:embed migrations/000035_knowledge.up.sql
var migrationUp35 string

//go:embed migrations/000035_knowledge.down.sql
