...
| **UAT** | `committedBundleSurfaces` (`evidence.go:2702`) **16 kayıt** (sayıldı). `PromoteGateFor` (`promote.go:67`) E21'i İLK dispatch eder |
...
| **D12** | *"`committedBundleSurfaces` 19 kayıt."* | **16.** `evidence.go:2702`'den bugün sayıldı | **T7**'nin sweep tablosu **16 → 17** olur |
