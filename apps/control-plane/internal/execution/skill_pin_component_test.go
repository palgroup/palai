...
func TestSkillDigestPinnedRunRecordsExactDigest(t *testing.T) {
	...
	exec(`INSERT INTO skill_revisions (id, project_id, skill_id, revision_number, digest, state, metadata, archive)
	      VALUES ($1,$2,$3,1,$4,'enabled','{"name":"commit-convention","description":"write commits"}','\x00')`,
	...
	exec(`INSERT INTO agent_revisions (id, project_id, profile_id, revision_number, model, tools, skills, published_at)
	      VALUES ($1,$2,$3,1,'model-pinned','["file"]','["commit-convention"]',clock_timestamp())`,
	...
	exec(`INSERT INTO skill_revisions (id, project_id, skill_id, revision_number, digest, state, metadata, archive)
	      VALUES ($1,$2,$3,2,$4,'enabled','{"name":"commit-convention","description":"v2"}','\x00')`,
