...
func NewRouter(verifier middleware.Verifier, admitter Admitter, events EventReader, sessions SessionManager, bindings BindingRegistrar, webhooks WebhookAPI, sse SSEConfig, runner http.Handler) http.Handler {
